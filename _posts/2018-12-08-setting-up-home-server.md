...
* I selected DYNU as the Dynamic DNS Service provider and created an account with them: https://www.dynu.com/en-US/. This is a free service 
and you can get a domain (I chose `sanzgiri.freeddns.org`) and IPv4 address
